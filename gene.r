...
#Manish Bhandari : College ID - 240225
...
#--------------------------------------------------------------------------------
#Import data (X.csv)
Xdata = (read.csv(file = "C:/Users/Manish/Downloads/GeneData.csv", header = T))
...
TimeData = (read.csv(file = "C:/Users/Manish/Downloads/GeneData.csv", header = T))
